...
def extrair_dados_xml(xml_content):
    try:
        ...
        if chave_acesso and chave_acesso.lower().startswith("nfe"):
            chave_acesso = chave_acesso[3:]  # remove o prefixo "NFe" da chave
    ...
    try:
                ...
                if not xml_files:
                    ...
                    for i, file_name in enumerate(xml_files):
                        with zf.open(file_name) as xml_file:
                            ...
                            _, chave_acesso = extrair_dados_xml(xml_content)  # 👈 usamos a chave aqui
                            ...
                            if pdf_bytes:
                                if chave_acesso:
                                    output_pdf_name = f"{chave_acesso}.pdf"  # 👈 nome do PDF pela chave
                                else:
        ...
        # PROCESSAR XML ÚNICO
            ...
            with st.spinner('Gerando o DANFE...'):
                ...
                _, chave_acesso = extrair_dados_xml(xml_bytes)  # 👈 chave usada no nome
                ...
                if pdf_bytes:
                    ...
                    if chave_acesso:
                        output_filename = f"{chave_acesso}.pdf"  # 👈 nome do arquivo = chave
                    else:
